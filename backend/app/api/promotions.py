    ...
    return [
        {
            ...
            "last_verified_at": alert.last_verified_at.isoformat() if alert.last_verified_at else None,
            "start_date": alert.start_date.isoformat() if alert.start_date else None,
            "end_date": alert.end_date.isoformat() if alert.end_date else None,
            "detected_bonus_percentage": alert.detected_bonus_percentage,
